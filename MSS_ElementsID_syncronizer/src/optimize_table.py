...
file_path = "C:/00_MS_PSP/000_Tools/ArchiCAD/000_PY_4_ArchiCAD/MSS_Door_type_excel_sync/01_PRH_Doors.xlsx"

fd= read_excel_file(file_path)

if fd is not None:
    print("File read successfully")

fd = remove_duplicates(fd)

fd.to_excel(file_path, index=False)

print("Duplicates removed")
    # Remove duplicates based on the first three columns
